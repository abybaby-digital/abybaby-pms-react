                        ...
                        <div className="card-body p-5 bg-white shadow overflow-hidden">
                            {isLoading ? (
                                ...
                                <div>
                                    ...
                                    {/* DataTable */}
                                    <DataTable value={filteredPayments} stripedRows rows={5} rowsPerPageOptions={[5, 10, 25, 50]} tableStyle={{ minWidth: '20rem' }} paginator paginatorTemplate="RowsPerPageDropdown FirstPageLink PrevPageLink CurrentPageReport NextPageLink LastPageLink"
                                        ...
                                        <Column header="Actions" body={(rowData) => (
                                            <>
                                                <TooltipProvider>
                                                    <Tooltip>
                                                        <TooltipTrigger>
                                                            <button className="bg-white shadow p-2 rounded me-2 hover:scale-110 active:scale-95" onClick={() => singlePayment(rowData.id, "view")}>
                                                                <FaEye />
                                                            </button>
                                                        </TooltipTrigger>
                                                        <TooltipContent>
                                                ...
                                                <TooltipProvider>
                                                    <Tooltip>
                                                        <TooltipTrigger>
                                                            <button className="bg-white shadow p-2 rounded me-2 hover:scale-110 active:scale-95" onClick={() => singlePayment(rowData.id, "edit")}>
                                                                <MdEditSquare />
                                                            </button>
                                                        </TooltipTrigger>
                                                        <TooltipContent>
                            ...
                            {addOrEdit === "view" && <ViewPaymentReceived payment={singlePaymentData} />}
                            {addOrEdit === "edit" && <EditPaymentReceived payment={singlePaymentData} />}
                        </div>
                    </div>
                </div>
            </SidebarInset>
