...
import EditPaymentRequisition from "./EditFOPaymentRequisition"; // Assuming you have an EditPaymentReceived component
import { useSelector } from "react-redux";
import RequisitionApproval from "./FORequisitionApproval";
import FoExpenseListById from "./FoExpenseListById";

const ViewFOPaymentRequisition = ({ payment, add_or_edit }) => {
                ...
                <DialogContent className="pb-5">
                    <DialogHeader>
                        <DialogTitle className="text-center text-xl font-bold font-merri">
                            {add_or_edit === "view" ? "FO Payment Requisition Details" : add_or_edit === "edit" ? " FO Payment Requisition Edit" : "Fo Expense List"}
                        </DialogTitle>
                        <DialogClose
                            asChild
                    ...
                    <DialogDescription>
                        {add_or_edit === "view" ?
                            ...
                            add_or_edit === "edit" ?
                                ...
                                :
                                <FoExpenseListById payment={payment} />}
                    </DialogDescription>
                </DialogContent>
            </Dialog>
...
export default ViewFOPaymentRequisition;
