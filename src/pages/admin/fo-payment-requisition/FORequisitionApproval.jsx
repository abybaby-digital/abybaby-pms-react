...
import { approveFoPaymentRequisition } from "../../../services/api";
import { useSelector } from "react-redux";
import toast from "react-hot-toast";
import { dialogOpenCloseContext } from "../../../context/DialogOpenClose";

const FORequisitionApproval = ({
  payment,
  role_id,
  role_name,
  veto_power,
  ...
  const handleApprove = async (
    ...
    setLoading(true);
    const response = await approveFoPaymentRequisition(
      token,
      fo_payment_requition_id,
      approved_amount,
      status
...
export default FORequisitionApproval;
